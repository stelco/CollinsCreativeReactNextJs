      ...
      {links.map((link) => {
        ...
        return (
          <Link
            ...
            href={link.href}
            className={cn(
              "flex h-[48px] grow items-center justify-center gap-2 rounded-xl border-gray-300 bg-gray-100 p-2 text-sm font-medium md:flex-none md:justify-start md:p-2 md:px-3 text-slate-600 hover:text-orange-600",
