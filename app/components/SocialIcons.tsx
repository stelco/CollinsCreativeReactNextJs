export default function SocialIcons() {
  return (
    <div className="hidden sm:flex align-middle">
      <a href="https://www.linkedin.com/in/steven-collins-26367733/" target="_blank" className="text-gray-400 hover:text-gray-500">
      ...
      <a href="https://www.facebook.com/stec74" target="_blank" className="ml-6 text-gray-400 hover:text-gray-500">
      ...
      <a href="https://x.com/Stelco74" target="_blank" className="ml-6 text-gray-400 hover:text-gray-500">
        <span className="sr-only">X</span>
        <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 16 16">
          <path d="M12.6.75h2.454l-5.36 6.142L16 15.25h-4.937l-3.867-5.07-4.425 5.07H.316l5.733-6.57L0 .75h5.063l3.495 4.633L12.601.75Zm-.86 13.028h1.36L4.323 2.145H2.865z" />
        </svg>
      </a>
      <a href="https://github.com/stelco" target="_blank" className="ml-6 text-gray-400 hover:text-gray-500">
