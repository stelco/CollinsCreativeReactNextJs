const uiux = [
    ...
    },
    {
        ...
        githubLink: true,
        value: 'This component is used to display information in a card format. All elements within the card data are optional and fully customisable. The component was built from a design using React, SASS and Typescript and is fully responsive.',
        value2: 'See GitHub link above and it also has Storybook documentation which is available from the button below.',
        image: '/uiux/card-component.jpg',
        isWorkItem: true,
        buttonLink: true,
        buttonLink2: true,
        buttonLinkUrl: 'https://bet365-test-26r24mvu9-steven-collins-projects.vercel.app/',
        buttonLinkUrl2: 'https://bet365-test-lnyhhflo4-steven-collins-projects.vercel.app/',
        buttonLinkUrlBlank: true,
    },
    {
        heading: 'Material Grid Component',
        url: 'https://github.com/stelco/system-loco-test',
        githubLink: true,
        value: 'This component is used to display information in a grid format. All data is retrieved from external Rest API endpoints. The component was built using React v18, Google Material, MUI Data grid, SASS and Typescript',
        value2: 'See GitHub link above and it also has Storybook documentation which can be run locally.',
        image: '/uiux/grid-component.jpg',
        isWorkItem: true,
        buttonLink: true,
        buttonLink2: true,
        buttonLinkUrl: 'https://system-loco-test.vercel.app/',
        buttonLinkUrlBlank: true,
    },
    {
        heading: 'UX Videos',
