...
export default function Page() {
  ...
  return (
    <>
      <Head>
        <title>Collins Creative | AI Hume Raw Text Processor</title>
        <meta name="description" content="This project demonstrates how to use the Hume SDK with Next.js to process raw text and generate emotional responses. Ive integrated the Hume SDK into my portfolio and created a simple text processor where you can input text and see the emotional response generated by the Hume model." />
      ...
      <main className="flex min-h-screen flex-col">
        ...
        <div className={"grow flex flex-col text-white dark:text-grey-100 mt-4 bg-gray-100 rounded-xl p-2 shadow-sm bg-grey-100 dark:bg-gray-600"}>
          <div className={'background-animation'} style={{ height: 'auto' }}>
            ...
            <animate></animate>
            <animate></animate>
            <div className="flex flex-col align-bottom md:flex-row gap-4 p-4 border-b-2 rounded-b-none border-gray-100 dark:border-gray-500" style={{ zIndex: 9999, position: 'relative' }}>
